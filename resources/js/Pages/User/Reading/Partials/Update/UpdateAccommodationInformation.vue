    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-4">
        <span class="flex gap-2">
          ...
          <span class="m-auto">
            <div
              v-if="form.active_status == false"
              @click="form.active_status = true"
              class="
                inline-flex
                items-center
                gap-6
            ...
            <div
              v-else
              @click="form.active_status = false"
              class="
                inline-flex
                items-center
                gap-6
...
const form = useForm({
  ...
  active_status: props.accommodation.active_status,
  remember: true,
});

function saleStatus() {
  if (form.active_status == true) {

...
class ProvinceController extends Controller
{
    ...
    public function bulawayo()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Bulawayo')->search(request('search'))->paginate(15),
                'path'=>'bulawayo',
                Filters::filters()
            ]
            ]);
    ...
    public function harare()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Harare')->search(request('search'))->paginate(15),
                Filters::filters(),
                'path'=>'harare'
            ]
            ]);
    ...
    public function manicaland()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Manicaland')->search(request('search'))->paginate(15),
                Filters::filters(),
                'path'=>'manicaland',
            ]
            ]);
    ...
    public function mashonalandCentral()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Mashonaland Central')->search(request('search'))->paginate(15),
                Filters::filters(),
    ...
    public function mashonalandEast()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Mashonaland East')->search(request('search'))->paginate(15),
                Filters::filters(),
    ...
    public function mashonalandWest()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Mashonaland West')->search(request('search'))->paginate(15),
                Filters::filters(),
    ...
    public function masvingo()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Masvingo')->search(request('search'))->paginate(15),
                Filters::filters(),
                'path'=>'masvingo',
            ]
            ]);
    ...
    public function matebelelandNorth()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Matebeleland North')->search(request('search'))->paginate(15),
                Filters::filters(),
    ...
    public function matebelelandSouth()
    {
        return inertia('Camp/Present',[
            'data'=>[
                'users'=> Christian::where('status','present')->where('province','Matebeleland South')->search(request('search'))->paginate(15),
                Filters::filters(),
